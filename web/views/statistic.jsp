...
<div>
    ...
    <div class="section">
        <div id="chart4" class="container">
            ...
            <div class="chart-text">
                <p>From the High Score Tag Top 10, we can infer what kind of films people like and according to this, directors can aim at these categories to make more profit and produce better works.</p>
            </div>
    ...
    <div class="section">
        <div id="chart7" class="container">
            ...
            <div class="chart-text">
                <p>This is the chart to compare chinese favorite and foreign favorite, we can conclude that  score given by china is higher than foreigners'</p>
            </div>
    ...
    <div class="section">
        <div id="chart8" class="container">
            ...
            <div class="chart-text">
                <p>This chart displays the score fluctuation each year. From the four dimensions in the chart : max min avg variance ,we can judge the quality of the films of some year.</p>
            </div>
    ...
    <div class="section">
        <div id="chart9" class="container">
            ...
            <div class="chart-text">
                <p>From this diagram, we can guess the relation between the Youtube click times and gross. In general, the more click times, the more grosses.</p>
            </div>
        ...
        function makePieChartInfoForEachYearTopTagTop5() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    tempData = tempData.sort(function (a, b) { return a.value - b.value; })
                    var option = {
                        baseOption: {
                            timeline: {
                                axisType: 'category',
